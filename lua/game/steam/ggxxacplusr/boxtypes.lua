...
add(b_xx, b_a , b_v , b_xx,  b_xx, b_xx, b_xx, b_xx) -- 00h-07h
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 08h-0Fh
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_va) -- 10h-17h
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 18h-1Fh
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 20h-27h
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 28h-2Fh
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 30h-37h
add(b_xx, b_xx, b_xx, b_xx,  b_xx, b_xx, b_xx, b_xx) -- 38h-3Fh
--  +00h  +01h  +02h  +03h   +04h  +05h  +06h  +07h
